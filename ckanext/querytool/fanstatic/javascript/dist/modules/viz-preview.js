        ...
        return {
            ...
            createChart: function(t) {
                var e, n = this.options.x_axis.toLowerCase(),
                    ...
                    yp = this.options.axis_percentages,
                ...
                if (this.options.axis_percentages ===  true && !['sbar', 'shbar', 'pie', 'donut'].includes(this.options.chart_type)) {
                  if ('hbar' == this.options.chart_type) {
                    if (['.0%', '.1%', '.2%'].includes(this.options.x_tick_format)) {
                      base_info.xaxis.range = [0, 1]
                    } else {
                      base_info.xaxis.range = [0, 100]
                    }
                  } else {
                    if (['.0%', '.1%', '.2%'].includes(this.options.y_tick_format)) {
                      base_info.yaxis.range = [0, 1]
                    } else {
                      base_info.yaxis.range = [0, 100]
                    }
                  }
                }
...
//                }
            ...
            updateChart: function() {
                var t = this.el.closest(".chart_field"),
                    ...
                    yp = t.find("input[name*=chart_field_axis_percentages_]").is(":checked"),
