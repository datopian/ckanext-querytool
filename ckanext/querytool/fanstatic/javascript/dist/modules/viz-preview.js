    ...
    ckan.module("querytool-viz-preview", function() {
        ...
        return {
            ...
            createChart: function(t) {
                ...
                if (this.options.y_percentages ===  true && !['sbar', 'shbar', 'pie', 'donut'].includes(this.options.chart_type)) {
...
//                }
            ...
            updateChart: function() {
                var t = this.el.closest(".chart_field"),
                    ...
                    yp = t.find("input[name*=chart_field_y_percentages_]").is(":checked"),
