                ...
                $.each(t, function(t, e) {
                    ...
                    if ((e = $(e)).context.id.indexOf("chart_field") >= 0) {
                        var r = e.find("[id*=chart_field_graph_]"),
                            ...
                            na = e.find("[id*=chart_field_seq_color_]"),
                        ...
                        console.log(plotly)
                        console.log('JUST PRINTED PLOTLY FROM VIS SETTINGS')
