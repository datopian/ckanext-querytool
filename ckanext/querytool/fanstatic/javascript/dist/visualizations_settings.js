            ...
            function g() {
                ...
                $.each(t, function(t, e) {
                    ...
                    if ((e = $(e)).context.id.indexOf("chart_field") >= 0) {
                        ...
                        plotly.attr("id", "chart_field_plotly_" + i), plotly.attr("name", "chart_field_plotly_" + i), plotly_label.attr("id", "chart_field_plotly_label_" + i), plotly_label.attr("name", "chart_field_plotly_label_" + i)
