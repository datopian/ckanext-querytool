            ...
            function g() {
                ...
                $.each(t, function(t, e) {
                    ...
                    if ((e = $(e)).context.id.indexOf("chart_field") >= 0) {
                        ...
                        e.attr("id", "map_item_" + i), B.attr("id", "map_resource_" + i), B.attr("name", "map_resource_" + i), K.attr("id", "map_title_field_" + i), K.attr("name", "map_title_field_" + i), MT.attr("id", "map_custom_title_field_" + i), MT.attr("name", "map_customtitle_field_" + i), Y.attr("id", "map_key_field_" + i), Y.attr("name", "map_key_field_" + i), Q.attr("id", "map_data_key_field_" + i), Q.attr("name", "map_data_key_field_" + i), X.attr("id", "map_color_scheme_" + i), X.attr("name", "map_color_scheme_" + i), Z.attr("id", "map_size_" + i), Z.attr("name", "map_size_" + i), tt.attr("id", "map_module_" + i), et.attr("id", "map_field_filter_name_" + i), et.attr("name", "map_field_filter_name_" + i), it.attr("id", "map_field_filter_value_" + i), it.attr("name", "map_field_filter_value_" + i), rt.attr("id", "map_div_filter_value_" + i), nt.attr("id", "map_field_filter_alias_" + i), nt.attr("name", "map_field_filter_alias_" + i), at.attr("id", "map_div_filter_alias_" + i), ot.attr("id", "map_field_filter_visibility_" + i), ot.attr("name", "map_field_filter_visibility_" + i), lt.attr("id", "map_div_filter_visibility_" + i)
