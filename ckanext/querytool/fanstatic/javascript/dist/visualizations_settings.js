                ...
                $.each(t, function(t, e) {
                    ...
                    if ((e = $(e)).context.id.indexOf("chart_field") >= 0) { 
                        var r = e.find("[id*=chart_field_graph_]"),
                            ...
                            lwidth = e.find("[id*=chart_field_line_width_]");
                        ...
                        if(ltypes['length'] > 1) {
                            for(var x = 0; x < ltypes['length']; x++){
                                ...
                                lwidth[x].setAttribute("id", "chart_field_line_width_" + i+"_"+(x + 1))
                                lwidth[x].setAttribute("name", "chart_field_line_width_" + i+"_"+(x + 1))
                            }
                        } else {
                            ...
                            lwidth.attr("id", "chart_field_line_width_" + i+"_1")
                            lwidth.attr("name", "chart_field_line_width_" + i+"_1")
                        }
                        ...
                        plotly.attr("id", "chart_field_plotly_" + i), plotly.attr("name", "chart_field_plotly_" + i), lplotly.attr("id", "chart_field_plotly_line_" + i), lplotly.attr("name", "chart_field_plotly_line_" + i), plotly_label.attr("id", "chart_field_plotly_label_" + i), plotly_label.attr("name", "chart_field_plotly_label_" + i), donut_hole.attr("id", "chart_field_donut_hole_" + i), donut_hole.attr("name", "chart_field_donut_hole_" + i),
