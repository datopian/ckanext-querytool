                ...
                $.each(t, function(t, e) {
                    ...
                    if ((e = $(e)).context.id.indexOf("chart_field") >= 0) { 
                        var r = e.find("[id*=chart_field_graph_]"),
                            ...
                            donut_hole_c = e.find("[id*=donut_hole_]"),
                        ...
                        plotly.attr("id", "chart_field_plotly_" + i), plotly.attr("name", "chart_field_plotly_" + i), lplotly.attr("id", "chart_field_plotly_line_" + i), lplotly.attr("name", "chart_field_plotly_line_" + i), plotly_label.attr("id", "chart_field_plotly_label_" + i), plotly_label.attr("name", "chart_field_plotly_label_" + i), donut_hole.attr("id", "chart_field_donut_hole_" + i), donut_hole.attr("name", "chart_field_donut_hole_" + i), donut_hole_c.attr("id", "donut_hole_" + i), donut_hole_l.attr("for", "chart_field_donut_hole_" + i), bar_width.attr("id", "chart_field_bar_width_" + i), bar_width.attr("name", "chart_field_bar_width_" + i), bar_width_c.attr("id", "chart_bar_width_" + i), bar_width_l.attr("for", "chart_field_bar_width_" + i);
