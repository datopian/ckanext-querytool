        ...
        function handleItemsOrder() {
            ...
            $.each(items, function(i, item) {
                ...
                if (item.context.id.indexOf('chart_field') >= 0) {
                    ...
                    dropdownSecStartingColor.attr("id", "chart_field_seq_starting_color_" + order);  //  NOTE: mapped to sq
                    ...
                    var seq_color_field = item.find('[name*=map_seq_color_field_]');
                    ...
                    seq_color_field.attr('name', 'map_seq_color_field_' + order);
