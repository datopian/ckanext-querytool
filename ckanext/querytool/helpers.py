...
def get_map_color_scheme():
    ...
    colors = [
        {
            'value': '#feedde,#fdbe85,#fd8d3c,#e6550d,#a63603,#BE6C47,#FED5B8,#A27955,#A2978E,#EF9265',
            'text': _('Sequential')
        },
        {
<<<<<<< HEAD
        ...
        {
            'value': '#d7191c,#fdae61,#ffffbf,#abdda4,#2b83ba,#E56C6E,#C9E9C5,#1C5477,#FEE8D3,#C5DDEC',
            'text': _('Blue-Red')
        },
        {
            'value': '#a6611a,#dfc27d,#f5f5f5,#80cdc1,#018571,#BE8C58,#E7D2A0,#A2DAD1,#46A697,#B79F67',
            'text': _('Teal-Brown')
        },
        {
