...
class QuerytoolPlugin(plugins.SingletonPlugin):
    ...
    def before_map(self, map):
        ...
        map.connect(
            "group_edit", "/group/edit/{id}", controller=group_controller, action="edit"
        )
        map.connect(
            "group_new", "/group/new", controller=group_controller, action="new"
        )
        map.connect(
            "group_delete",
            "/group/delete/{id}",
        ...
        # Query tool routes
        map.redirect(
            "/querytool", "/querytool/groups", _redirect_code="301 Moved Permanently"
        )
        ...
        map.redirect(
            "/querytool/public",
            "/querytool/public/groups",
            _redirect_code="301 Moved Permanently",
        )

        map.connect(
            "querytool_list_other",
            "/querytool/group/other",
        ...
        map.connect(
            ...
            "/",
            controller=querytool_controller,
            action="querytool_public",
        )

        map.connect(
            "querytool_public_reports",
            "/querytool/public/reports",
            controller=querytool_controller,
            action="querytool_public_reports",
        )

        map.connect(
            "querytool_misc_groups",
        ...
        map.connect(
            "querytool_public_list_by_group",
        ...
        map.connect("index", "/", controller=home_controller, action="index")

        user_controller = "ckanext.querytool.controllers.user:QuerytoolUserController"
        map.connect("login", "/user/login", controller=user_controller, action="login")
        ...
        email_auth_controller = (
            "ckanext.querytool.controllers.email_auth:QuerytoolEmailAuthController"
        )
        map.connect(
            "send_2fa_code",
            "/send_2fa_code/{user}",
    ...
    def get_helpers(self):
        return {
            ...
            "querytool_get_numeric_resource_columns": helpers.get_numeric_resource_columns,
            "querytool_get_tick_text_rotation": helpers.get_tick_text_rotation,
            "queytool_get_charts_data_formats": helpers.get_charts_data_formats,
            "querytool_get_visualization_size": helpers.get_visualization_size,
            "querytool_get_uuid": helpers.get_uuid,
            "querytool_get_geojson_resources": helpers.get_geojson_resources,
            "querytool_get_geojson_properties": helpers.get_geojson_properties,
            "querytool_get_map_color_scheme": helpers.get_map_color_scheme,
            "querytool_get_chart_sort": helpers.get_chart_sort,
            "querytool_get_groups": helpers.get_groups,
            "querytool_get_group_title": helpers.get_group_title,
            "querytool_get_map_config": helpers.get_map_config,
            "querytool_hex_to_rgba": helpers.hex_to_rgba,
            "querytool_parse_y_axis_columns": helpers.parse_y_axis_columns,
            "querytool_pick_first_by_attr_value": helpers.pick_first_by_attr_value,
            "querytool_parse_json": helpers.parse_json,
            "querytool_dump_json": helpers.dump_json,
            "querytool_get_dataset_url_path": helpers.get_dataset_url_path,
            "querytool_get_all_reports": helpers.get_all_reports,
            "get_user_permission": helpers.get_user_permission,
            "get_groups_for_user": helpers.get_groups_for_user,
            "querytool_get_chart_colors": helpers.get_querytool_get_chart_colors,
            "get_edit_permission_for_user": helpers.get_edit_permission_for_user,
            "get_user_permission_type": helpers.get_user_permission_type,
            "get_is_admin_or_editor_of_any_group": helpers.get_is_admin_or_editor_of_any_group,
            "get_orgs_for_user": helpers.get_orgs_for_user,
            "get_organization": helpers.get_organization,
            "get_datasets_for_user": helpers.get_datasets_for_user,
            "get_all_orgs_for_user": helpers.get_all_orgs_for_user,
            "get_all_org_permissions": helpers.get_all_org_permissions,
            "convert_bar_width": helpers.convert_bar_width,
            "get_cookie_control_config": helpers.get_cookie_control_config,
            "get_social_media_links": helpers.get_social_media_links,
            "querytool_search": helpers.querytool_search,
            "report_search_count": helpers.report_search_count,
            "filter_reports_by_permissions": helpers.filter_reports_by_permissions,
            "filter_groups_by_permissions": helpers.group_count_design_reports,
            "color_to_hex": helpers.color_to_hex,
            "get_maps_data_formats": helpers.get_maps_data_formats,
            "get_available_groups": helpers.get_available_groups,
            "get_all_parent_groups": helpers.get_all_parent_groups,
            "get_recaptcha_config": helpers.get_recaptcha_config,
            "get_config_value": helpers.get_config_value,
            "get_all_group_names": helpers.get_all_group_names,
        ...
        schema.update(
            {
                ...
                "group_parents_enabled": [
                    ignore_missing,
                    logic.validators.boolean_validator,
                ],
            }
        )
