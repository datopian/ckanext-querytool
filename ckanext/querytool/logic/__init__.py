...
def check_access(action, context, data_dict=None):
    ...
    '''
    # We override check_access for querytool_update so group users can save
    # reports that use other datasets than those found in their org
    if action == 'querytool_update':
        return True
