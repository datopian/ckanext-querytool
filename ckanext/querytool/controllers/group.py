...
class QuerytoolGroupController(GroupController):
    ...
    def read_report(self, id):
        ...
        try:
            ...
            c.reports = toolkit.get_action("querytool_list_by_group")(
                context, {"group": id}
            )
    ...
    def edit(self, id, data=None, errors=None, error_summary=None):
        ...
        return render(
            self._edit_template(c.group.type), extra_vars={"group_type": group_type}
        )
    ...
    def new(self, data=None, errors=None, error_summary=None):
        ...
        return render(
            self._new_template(group_type), extra_vars={"group_type": group_type}
        )
